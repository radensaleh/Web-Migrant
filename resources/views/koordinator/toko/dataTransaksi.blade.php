...
<head>
    ...
    <title>Data Transaksi | Koordinator Migrant Shop</title>
...
<body>
                                    ...
                                    <tbody>
                                      @foreach($transaksi as $key => $data)
                                        <tr>
                                          ...
                                          <td>
                                            <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#detailData" data-kd_transaksi="{{ $data->kd_transaksi }}" data-nama_pemesan="{{ $data->nama_lengkap }}" data-foto_bukti="{{ $data->foto_bukti }}" data-tgl_transaksi="{{ $data->tgl_transaksi }}" data-total_harga="{{ $data->total_harga }}" data-nama_penerima="{{ $data->nama_penerima }}"><i class="fa fa-info"></i> Detail Transaksi</button>
                                            <button type="button" class="btn btn-danger btn-sm" onclick="dataPesanan('{{$data->kd_transaksi}}', '{{$kd_toko}}')" data-toggle="modal" data-target="#detailPesanan"><i class="fa fa-shopping-cart"></i> Detail Pesanan</button>
                                          </td>
                                        </tr>
                                      @endforeach
                                    </tbody>
    ...
    <script type="text/javascript">
        ...
        function dataPesanan(kd_transaksi, kd_toko){
            window.location.href = "http://192.168.8.101:8000/koordinator/toko/"+  kd_toko +"/" + kd_transaksi + "/dataPesanan";
        }
