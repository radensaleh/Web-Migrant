...
<body>
    ...
    <script type="text/javascript">
        ...
        function dataBarang(kd_toko){
            window.location.href = "http://192.168.8.101:8000/koordinator/toko/"+  kd_toko +"/dataBarang";
        }

        function dataPesanan(kd_toko){
            window.location.href = "http://192.168.8.101:8000/koordinator/toko/"+  kd_toko +"/dataPesanan";
        }
