...
<body>
                                    ...
                                    <tbody>
                                      @foreach($transaksi as $key => $data)
                                        <tr>
                                          ...
                                          <td><span class="btn btn-success btn-sm"><i class="fa fa-check-circle"></i> Sudah Dikonfirmasi</span></td>
                                          <td>
    ...
    <script type="text/javascript">
        ...
        function dataPesanan(kd_transaksi){
            window.location.href = "http://192.168.8.100:8000/admin/dataProsesTransaksi/toko/" + kd_transaksi + "/dataPesanan";
        }
