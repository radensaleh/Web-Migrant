...
<head>
    ...
    <title>Konfirmasi Pembayaran | Admin Migrant Shop</title>
...
<body>
                                    ...
                                    <tbody>
                                      @foreach($transaksi as $key => $data)
                                        <tr>
                                          ...
                                          <td><span class="btn btn-warning btn-sm"><i class="fa fa-clock-o"></i> Belum Dikonfirmasi</span></td>
                                          <td>
    ...
    <script type="text/javascript">
        ...
        function dataPesanan(kd_transaksi){
            window.location.href = "http://192.168.8.101:8000/admin/konfirmasiPembayaran/toko/" + kd_transaksi + "/dataPesanan";
        }
