...
<html lang="en">
<head>
	<title>Login | Admin Migrant Shop</title>
	<meta charset="UTF-8">
	<meta name="viewport" content="width=device-width, initial-scale=1">

<!--===============================================================================================-->
	<link rel="icon" type="image/png" href="/images/icon_migran.png"/>
<!--===============================================================================================-->
          ...
          <span class="login100-form-title p-b-26">
            ...
            Migrant Shop
					...
					<div class="wrap-input100">
						...
						<span class="focus-input100" data-placeholder="Username | ex. Admin123"></span>
					</div>
      ...
      formLogin.submit(function (e) {
          ...
          $.ajax({
              ...
              success: function( res ){
                  if(res.error == 1){
                    if(res.message.username != null){
                      new PNotify({
                          title: 'Alert!',
                          text: res.message.username,
                          type: 'warning',
                          icon: "fa fa-warning",
                          delay:1500
                      })
