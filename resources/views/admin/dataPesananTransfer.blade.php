...
<body>
    ...
    <div id="right-panel" class="right-panel">
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="{{ route('dataRiwayatTransfer') }}">Data Transaksi</a></li>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            ...
                                            @foreach($data->historis as $key => $historis)
                                              @if($key == 0)
                                                <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#buktiTransfer" data-foto="{{ $historis->foto_bukti }}"><i class="fa fa-camera"></i> Bukti Tranfer</button>
                                              @endif
                                            @endforeach
                                          </td>
                                        </tr>
        ...
        <div id="buktiTransfer" class="modal fade" role="dialog">
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title"><span class="fa fa-camera"></span> Bukti Transfer</h4>
              </div>
              <div class="modal-body">
                <table class="table table-striped table-bordered table-hover no-footer">
                    <tr>
                      <th colspan="2">
                        <img id="foto" src="" style="width: 100%; height: 100%" alt="Belum ada bukti Transfer" onerror="this.onerror=null; this.src='/images/not_found.jpg'">
                      </th>
                    </tr>
                </table>
              </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
          ...
          $('#buktiTransfer').on('show.bs.modal', function (event){
              event.preventDefault();
              ...
              if(foto != ""){
                loadImg = "http://192.168.8.101:8000/images/bukti_tf/"+foto
              }else{
