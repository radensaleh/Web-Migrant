        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href=""><i class="menu-icon fa fa-user"></i>Data Mahasiswa </a>
                    </li>
                    <li>
                        <a href=""><i class="menu-icon fa fa-user-secret"></i>Data Teknisi </a>
                    </li>
                    <li>
                        <a href=""><i class="menu-icon fa fa-qrcode"></i>Data Barang </a>
                    </li>
                    <li>
                        <a href=""><i class="menu-icon fa fa-tags"></i>Data Merk </a>
                    </li>
                    <li>
                        <a href=""><i class="menu-icon fa fa-bookmark-o"></i>Data Tipe </a>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </nav>
        ...
        <header id="header" class="header">
            <div class="top-left">
                <div class="navbar-header">
                    <a class="navbar-brand" href="{{ route('dashboardAdmin')}}">// LOGO GAN</a>
                                ...
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            ...
                                            <div class="stat-heading">Teknisi</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            ...
                                            <div class="stat-heading">Merk</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
